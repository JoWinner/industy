  ...
  return (
    <div className='max-w-[1400px] h-[500px] bg-[#040e26] mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid grid-cols-2 gap-4 text-left '>
      <div className='lg:top-20 relative lg:col-span-1 col-span-2'>
        <h3 className='text-4xl md:text-5xl font-bold mb-4 text-white'>At the heart of Greenroots Trading Company Ltd.</h3>
        <p className='pt-4 text-lg text-gray-300'>
          Greenroots Trading Company Ltd a subsidiary of the Cash crop Supplier has earned the reputation,
          trust and respect of our clients within the global Cash crop economy for having a great operation structure,
          people and for providing excellent service to our clients through the sale and delivery of quality cocoa beans, cashews, coffee.
